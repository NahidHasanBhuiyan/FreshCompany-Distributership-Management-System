...
<head>
	...
	<title>Fresh :: Purchase List</title>
						...
						<div class="form-group">
							...
							<select name="product" id="" class="form-control">
								...
								<?php
									...
									$lift = $conn-> query("SELECT * FROM product");
									while($lifting = $lift->fetch_assoc()):
								?>
								<option value="<?php echo $lifting['product_id']?>"><?php echo $lifting['product_name']?></option>
							<?php endwhile;?>
							</select>
						</div>
					</div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    ...
                                    <h3 class="alert bg-success"><b>Purchase List 
                                    	<?php
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="DD Rate">DD Rate</th>
                                                <th data-field="Qty" data-editable="false">Qty</th>
                                        ...
                                        <tbody>
											...
											if($product!=NULL){
												$dd = $conn-> query("SELECT * FROM purchase_item WHERE today_date BETWEEN '$from' AND '$to' AND product_id='$product' ");
											}else{
												$dd = $conn-> query("SELECT * FROM purchase_item WHERE today_date BETWEEN '$from' AND '$to' ");
											}
