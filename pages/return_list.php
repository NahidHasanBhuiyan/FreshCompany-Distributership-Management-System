...
<head>
	...
	<title>Fresh :: Return Product List</title>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    ...
                                    <h3 class="alert bg-success"><b>Return List 
                                    	<?php
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="Return From">Return From</th>
                                                <th data-field="TP Rate">TP Rate</th>
                                        ...
                                        <tbody>
											...
											if($liftii!=NULL){
												$dd = $conn-> query("SELECT * FROM return_item WHERE today_date BETWEEN '$from' AND '$to' AND return_value_id='$liftii' ");
											}else{
												$dd = $conn-> query("SELECT * FROM return_item WHERE today_date BETWEEN '$from' AND '$to' ");
											}
